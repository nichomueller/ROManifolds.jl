...
dir = datadir("stokes_pod")
create_dir(dir)
fesnaps = ExamplesInterface.try_loading_fe_snapshots(dir,rbsolver,feop)
...
rbop = ExamplesInterface.try_loading_reduced_operator(dir_tol,rbsolver,feop,fesnaps)
x̂,rbstats = solve(rbsolver,rbop,μon)
plot_a_solution(plot_dir_tol,feop,rbop,x,x̂,μon;trian=Ω)
