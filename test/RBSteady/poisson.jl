...
# add! = RBTransient.AddKroneckerHREntriesMap(+,locations)
# add_cache = return_cache(add!,b,vals1,rows1)

# # AA,BB=RBTransient.get_param_itimes(rhs_strian,hr_param_time_ids)

# cell = 1
# rows = getindex!(rows_cache,cellidsrows,cell)
# vals = getindex!(vals_cache,cellvec,cell)
# # RBTransient.add_kronecker_hr_entries!(add_cache,+,b_strian,vals,rows,locations)

# li = 4
# i = rows[li]
# RBSteady.get_param_entry!(add_cache,vals,li)
# RBSteady.add_kron_entry!(combine,b_strian,add_cache,lt,i)
