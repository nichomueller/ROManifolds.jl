...
"""
    const UnfoldingTransientSnapshots{T,L,R}
      = AbstractTransientSnapshots{T,3,L,1,<:AbstractTrivialIndexMap,R}

"""
const UnfoldingTransientSnapshots{T,L,R} = AbstractTransientSnapshots{T,3,L,1,<:AbstractTrivialIndexMap,R}
