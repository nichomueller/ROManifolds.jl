...
function Gridap.Arrays.evaluate(pa::ParamStructure,args...)
  pa.f(args...)
end

function Gridap.Arrays.evaluate(pa::Vector{ParamStructure},args...)
...
function Gridap.Arrays.evaluate(pa::Matrix{ParamStructure},args...)
