...
ParamSteady.get_induced_norm(op::TransientParamSemilinearFEOpFromWeakForm) = op.induced_norm
...
ParamSteady.get_induced_norm(op::TransientParamLinearFEOpFromWeakForm) = op.induced_norm
