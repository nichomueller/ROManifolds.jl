...
ParamSteady.get_induced_norm(op::TransientParamSaddlePointFEOp) = get_induced_norm(op.op)
ParamSteady.get_coupling(op::TransientParamSaddlePointFEOp) = op.coupling
