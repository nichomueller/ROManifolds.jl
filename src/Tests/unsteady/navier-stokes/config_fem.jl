...
function get_operator(
  ...
  res(t,(u,p),(v,q)) = m(t,(∂t(u),∂t(p)),(v,q)) + a(t,(u,p),(v,q)) + c(u,v) - rhs(t,(v,q))
  jac(t,(u,p),(du,dp),(v,q)) = a(t,(du,dp),(v,q)) + dc(u,du,v)
  jac_t(t,(u,p),(dut,dpt),(v,q)) = m(t,(dut,dpt),(v,q))

  operator = TransientFEOperator(res, jac, jac_t, X, X₀)
...
function _get_g(FEMInfo::FOMInfoST, μ::Vector)
  ...
  function g(x, t::Real)
    if "L" ∈ FEMInfo.affine_structures
      ...
      return 1e-4*sin(t) * VectorValue(μ[7] * cos(x[2]) + μ[8] * sin(x[3]), 0., 0.) .* (x[1] == 0.)
    end
  end
  g(t::Real) = x -> g(x, t)
