...
include("../../../src/RB/NavierStokesST.jl")

function config_RB(ϵₛ::Float, ϵₜ::Float)

  println("Setting up the RB solver, steady Navier-Stokes problem")
  ...
  RBInfo = ROMInfoST{3}(FEMInfo, RBPaths, considered_snaps, ϵₛ, ϵₜ,
