...
save_CSV(lazy_solution_info[1][4][2], joinpath(paths.FEM_structures_path, "H.csv"))
if case === 0
  save_CSV(lazy_solution_info[1][4][1], joinpath(paths.FEM_structures_path, "F.csv"))
  save_CSV(lazy_solution_info[1][3], joinpath(paths.FEM_structures_path, "A.csv"))
end
if case === 1
  save_CSV(lazy_solution_info[1][4][1], joinpath(paths.FEM_structures_path, "F.csv"))
end
