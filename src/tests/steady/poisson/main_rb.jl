...
function setup_RB()
  ...
  ROM_info = ROM_specifics(case, paths, RB_method, problem_nonlinearities, considered_snaps, ϵˢ, postprocess, import_snapshots, import_offline_structures, save_offline_structures, save_results)
  if RB_method === "S-GRB"
...
function run_RB()
  ...
  μ_nbs = 15:20
  testing_phase(ROM_info, RB_variables, μ_nbs, μ)
